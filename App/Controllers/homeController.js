'use strict';
LiveOdiaApp.controller('homeController', ['$scope', '$rootScope', '$location', 'homeServiceFactory', 'HotnewsServiceFactory', 'mobileCheck', function ($scope, $rootScope, $location, homeServiceFactory, HotnewsServiceFactory, mobileCheck) {
    debugger;
